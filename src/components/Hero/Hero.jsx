      ...
      >
        ...
        >
          ...
          <div className="text-white gap-7 flex mr-7 ">
            <a href="https://www.facebook.com/pages/Fitness-Pulse-Gym-Jhotwara/175771099837793">
            <i className="fa-brands rotate-90 hover:text-[#FF0336] fa-facebook text-3xl cursor-pointer ease-in duration-200 "></i></a>
             <a href="https://www.instagram.com/fitnesspulsegymjaipur?igsh=cTZobDFodDN0Mjcz"><i className="fa-brands rotate-90 hover:text-[#FF0336] fa-instagram text-3xl cursor-pointer ease-in duration-200"></i></a>
