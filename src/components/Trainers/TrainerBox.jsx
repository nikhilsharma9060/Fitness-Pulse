import Trainer1 from "../../images/trainers/2.jpg";
import Trainer2 from "../../images/trainers/9.jpg";
import Trainer3 from "../../images/trainers/11.jpg";
...
function TrainerBox() {
  ...
  const trainers = [
    { img: Trainer1, name: "Narendra Kumar", job: "Yoga Trainer" },
    { img: Trainer2, name: "Surya Dixit", job: "Crossfit Trainer" },
    { img: Trainer3, name: "Krishna kumar", job: "Personal Trainer" },
  ];
