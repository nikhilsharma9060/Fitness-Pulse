  ...
  return (
    <>
      <section>
        ...
        <div className="bg-white py-[12rem] page-padding grid grid-cols-2 container gap-10 items-center md1000:grid-cols-1 ">
          ...
          <div className="md1000:w-[60%] md1000:flex md1000:flex-col md1000:mx-auto min800:w-[90%] min620:w-full">
            ...
            <p className="text-[16px] w-[95%] text-[#646464] font-medium my-[40px]">
              At Fitness pulse, we are dedicated to helping you achieve the body of
            ...
            <div className="grid grid-cols-2 grid-rows-2 gap-y-20 min620:grid-cols-1 min620:mx-auto">
              <div className="flex flex-col relative">
                ...
                Kalwar Rd, Suraj Nagar
                  <br />Jhotwara, Jaipur, Rajasthan 302012
                </p>
              </div>
              {/*  */}
              <div className="flex flex-col relative">
                ...
                <div className="text-[15px] font-medium text-[#646464]">
                  <p>Mon to Friday: 7:30 am — 1:00 am</p>
                  <p>Sat to Sun : 7:00am - 8:00pm</p>
                </div>
              </div>
              {/*  */}
              <div className="flex flex-col relative">
                ...
                <div className="text-[15px] font-medium text-[#646464]">
                  <p>+91 9887000058</p>
                  <p>&nbsp; fitnesspulse2012@gmail.com</p>
                </div>
              </div>
              {/*  */}
              <div className="flex flex-col relative">
          ...
          {/* second col ---*/}
          <form className="flex flex-col pt-[30px] pr-[50px] pb-[50px] pl-[45px] bg-[#f8f8f8] relative md1000:w-[65%] md1000:flex md1000:flex-col md1000:mx-auto md1000:mt-14 min800:w-[90%] min620:w-full" action="https://formspree.io/f/xrgnopbk" method="post">
            ...
            <button
              type="submit"
              className="text-white bg-[#ff0336] w-fit py-[15px] px-[30px] font-bold text-[14px] uppercase self-center mt-6" value="send message"
            >
              submit now
            </button>
          </form>
        ...
        {/* map */}
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3556.6843582308597!2d75.7365146749486!3d26.94521925869375!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x396db317b08e2f47%3A0x785cb028761858a8!2sFitness%20Pulse%20Gym!5e0!3m2!1sen!2sin!4v1711916681834!5m2!1sen!2sin"
          allowFullScreen=""
          loading="lazy"
          samesite="Strict"
          title="map"
...
{/* <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3556.6843582308597!2d75.7365146749486!3d26.94521925869375!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x396db317b08e2f47%3A0x785cb028761858a8!2sFitness%20Pulse%20Gym!5e0!3m2!1sen!2sin!4v1711916681834!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe> */}