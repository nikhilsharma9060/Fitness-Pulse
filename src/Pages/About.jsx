          ...
          <div className="mt-[10rem]">
            <div className="grid grid-cols-2 grid-rows-2 w-full min620:grid-cols-1">
              <div className="w-full bg-white h-[43rem] flex flex-col justify-center items-center text-center px-[100px] min800:px-[10px]">
                ...
                <h2 className="text-[36px] font-bold mt-3">Introduction</h2>
                <p className="text-[16px] font-medium text-[#646464] mt-5">
                At Fitness Pulse, our journey began with a simple yet powerful vision: to empower individuals to lead healthier, happier lives through fitness and wellness. Founded in 2012, Fitness Pulse has since become a cornerstone of the Jaipur fitness community, driven by a passion for excellence and a dedication to our members' success.
                </p>
              </div>
              {/*  */}
              ...
              <div className="w-full bg-white h-[43rem] flex flex-col justify-center items-center text-center px-[100px] min800:px-[10px]">
                ...
                <h2 className="text-[36px] font-bold mt-3">Address</h2>
                <p className="text-[16px] font-medium text-[#646464] mt-5">
                Kalwar Rd, Suraj Nagar, Jhotwara, Jaipur, Rajasthan 302012
                </p>
              </div>
            </div>
          </div>
